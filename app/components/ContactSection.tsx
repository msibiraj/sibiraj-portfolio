	...
	return (
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				<h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-white">Let&apos;s Build Something Amazing</h2>
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="https://mail.google.com/mail/u/0/?view=cm&amp;fs=1&amp;tf=1&amp;source=mailto&amp;to=sibiraj.munirathinam@gmail.com"
				...
				<div className="flex justify-center gap-6">
					<a
						href="https://github.com/msibiraj" // Replace with your GitHub URL
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/sibiraj-m-271272366/"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
					>
