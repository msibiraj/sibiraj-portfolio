			...
			<div className="relative z-10 max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							...
							<p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
								Web developer with 3+ years of experience building full-stack applications using Node.js, React, AWS, MongoDB, and more.
							</p>
						</div>

						{/* Tech Stack Pills */}
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['React', 'TypeScript', 'Node.js', 'Express', 'AWS', 'MongoDB', 'MySQL', 'DynamoDB', 'Redux'].map((tech) => (
								<span
									key={tech}
					...
					<div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
						{[
							{ name: 'GitHub', icon: '🐙', href: 'https://github.com/msibiraj' }, // Replace with actual GitHub link if available
							{ name: 'LinkedIn', icon: '💼', href: 'https://www.linkedin.com/in/sibiraj-m-271272366/' },
							{ name: 'Email', icon: '✉️', href: 'https://mail.google.com/mail/u/0/?view=cm&amp;fs=1&amp;tf=1&amp;source=mailto&amp;to=sibiraj.munirathinam@gmail.com' },
						].map((social) => (
